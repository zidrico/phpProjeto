        ...
        <main>  
            ...
            <div id="janela_transportadoras">
                ...
                <ul>
                    ...
                    <li><a href="alteracaoTransp.php?codigo=<?php echo $linha["transportadoraID"] ?>">Alterar</a> </li>
                    <li><a href="exclusaoTransp.php?codigo=<?php echo $linha["transportadoraID"] ?>">Excluir</a> </li>
                </ul>
                ...
                ?>
                <ul>
                    <li><a href="inserirTransp.php">Incluir Transportadora</a></li>
                </ul>
            </div>
        </main>
